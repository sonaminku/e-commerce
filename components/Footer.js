  ...
  return (
    <footer className="sticky bottom-0 bg-white p-5 w-full flex border-t border-gray-200 justify-center space-x-12 text-gray-400">
      <Link legacyBehavior href={'/'}>
        <a className={(path === '/' ? 'text-emerald-500' : '') + "items-center justify-center flex flex-col"}>
          <svg
      ...
      <Link legacyBehavior href={'/checkout'}>
        <a className={(path === '/checkout' ? 'text-emerald-500' : '') + "items-center justify-center flex flex-col"}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
